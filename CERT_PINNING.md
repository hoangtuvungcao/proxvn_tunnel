...
```bash
# HTTP Tunnel
proxvn --proto http 3000 --cert-pin 8ff1f269fa914ff6a6467ee7f9b8d7822408c67cbc6fd0c656532c9e68f3d071

# TCP Tunnel  
proxvn 22 --cert-pin 8ff1f269fa914ff6a6467ee7f9b8d7822408c67cbc6fd0c656532c9e68f3d071

# UDP Tunnel
proxvn --proto udp 19132 --cert-pin 8ff1f269fa914ff6a6467ee7f9b8d7822408c67cbc6fd0c656532c9e68f3d071
```
...
**Expected Output:**
```
Fingerprint: 8ff1f269fa914ff6a6467ee7f9b8d7822408c67cbc6fd0c656532c9e68f3d071
```
...
SERVER="103.77.246.111:8882"
EXPECTED="8ff1f269fa914ff6a6467ee7f9b8d7822408c67cbc6fd0c656532c9e68f3d071"
...
Usage:
========================================
proxvn.exe --server 103.77.246.111:8882 `
           --cert-pin a1b2c3d4e5f6789012345678901234567890abcdef1234567890abcdef123456 `
           --proto http 3000
```
...
Test-NetConnection -ComputerName 103.77.246.111 -Port 8882
```
