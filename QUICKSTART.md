...
**Kết nối từ máy khác:**
```
Windows: mstsc /v:103.77.246.111:10001
macOS:   Microsoft Remote Desktop → 103.77.246.111:10001
```
...
**Kết nối:**
```bash
ssh your-username@103.77.246.111 -p 10002
```
...
**Bạn bè connect:**
```
Server Address: 103.77.246.111:10003
```
...
**Kết nối:**
```bash
mysql -h 103.77.246.111 -P 10005 -u root -p
```
...
**Kết nối:**
```bash
psql -h 103.77.246.111 -p 10006 -U postgres
```
...
**A:** 
1. Check internet: `ping 103.77.246.111`
...
- 🔐 **[CERT_PINNING.md](CERT_PINNING.md)** - Certificate pinning chi tiết
- 🏠 **[DOMAIN_SETUP.md](DOMAIN_SETUP.md)** - Self-hosting guide
